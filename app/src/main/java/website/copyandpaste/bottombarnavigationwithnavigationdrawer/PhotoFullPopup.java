...
//
//public class PhotoFullPopup extends PopupWindow {
//
//    View view;
//    Context mContext;
//    PhotoView photoView;
//    ProgressBar loading;
//    ViewGroup parent;
//    private static PhotoFullPopup instance = null;
//
//
//
//    public PhotoFullPopup(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
//        super(((LayoutInflater) ctx.getSystemService(LAYOUT_INFLATER_SERVICE)).inflate( R.layout.popup_photo_full_screen, null), ViewGroup.LayoutParams.MATCH_PARENT,
